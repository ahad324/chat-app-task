              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-slate-800 p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex flex-col items-center">
                    ...
                    <Dialog.Title
                      as="h3"
                      className="text-2xl font-semibold leading-6 text-gray-900 dark:text-gray-100 text-center mt-4"
                    >
                      {displayUser?.name}
                    </Dialog.Title>
                    <p className="text-md text-gray-500 dark:text-gray-400 mt-2">Email: {displayUser?.email}</p>
                  </div>
