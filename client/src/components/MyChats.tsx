...
const MyChats = () => {
  ...
  const fetchChats = async () => {
    ...
    try {
      ...
      alert(`Error Occurred! Failed to load the chats Error:${error}`);
    }
  };
  ...
  return (
    <div
      className={`flex-col items-center p-3 bg-white dark:bg-slate-800 w-full md:w-1/3 rounded-lg border dark:border-slate-700 ${selectedChat ? 'hidden md:flex' : 'flex'}`}
    >
